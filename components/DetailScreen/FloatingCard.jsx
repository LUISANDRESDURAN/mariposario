...
export default function FloatingCard({ nombre, cientifico, favorite, onToggleFavorite, theme, styles, mariposaId }) {
  ...
  return (
    <View style={[styles.floatingCard, { backgroundColor: theme.cardBackground + 'CC', shadowColor: theme.text }]}> 
      ...
      <TouchableOpacity onPress={handleToggleFavorite} style={styles.favoriteCircle} disabled={!user}>
        <Icon
